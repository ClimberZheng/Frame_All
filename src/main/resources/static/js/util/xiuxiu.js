...
xiuxiu.embedSWF = function (b, c, f, m, e) {
    ...
    if (document.getElementById(xiuxiu.container)) {
        document.getElementById(xiuxiu.container).innerHTML = '<p><a href="' + xiuxiu.protocol + '//www.adobe.com/go/getflashplayer"><img alt="Get Adobe Flash player" src="' + xiuxiu.protocol + '//wwwimages.adobe.com/www.adobe.com/images/shared/download_buttons/get_flash_player.gif"></a></p>'
    }
    ...
    swfobject.embedSWF(a, xiuxiu.container, f, m, g, xiuxiu.protocol + "//open.web.meitu.com/sources/expressInstall.swf", h, l, xiuxiu.attributes);
